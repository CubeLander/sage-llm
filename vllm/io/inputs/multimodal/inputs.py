...
[`MultiModalDataBuiltins`][vllm.io.inputs.multimodal.inputs.MultiModalDataBuiltins].
"""
...
def nested_tensors_equal(a: NestedTensors, b: NestedTensors) -> bool:
    ...
    [`NestedTensors`][vllm.io.inputs.multimodal.inputs.NestedTensors] objects."""
...
[`MultiModalKwargs.batch`][vllm.io.inputs.multimodal.inputs.MultiModalKwargs.batch].
"""
...
class MultiModalFieldElem:
    ...
    in [`MultiModalKwargs`][vllm.io.inputs.multimodal.inputs.MultiModalKwargs].
    """
    ...
    [`MultiModalKwargs`][vllm.io.inputs.multimodal.inputs.MultiModalKwargs],
...
class BaseMultiModalField(ABC):
    ...
    [`MultiModalKwargs`][vllm.io.inputs.multimodal.inputs.MultiModalKwargs] for multiple
    ...
    def build_elems(
        ...
        """
        Construct
        [`MultiModalFieldElem`][vllm.io.inputs.multimodal.inputs.MultiModalFieldElem]
        instances to represent the provided data.

        This is the inverse of
        [`reduce_data`][vllm.io.inputs.multimodal.inputs.BaseMultiModalField.reduce_data].
        """
    ...
    def reduce_data(self, elems: list[MultiModalFieldElem]) -> NestedTensors:
        ...
        This is the inverse of
        [`build_elems`][vllm.io.inputs.multimodal.inputs.BaseMultiModalField.build_elems].
        """
...
class MultiModalBatchedField(BaseMultiModalField):
    """
    Info:
        [`MultiModalFieldConfig.batched`][vllm.io.inputs.multimodal.inputs.MultiModalFieldConfig.batched]
    """
...
class MultiModalFlatField(BaseMultiModalField):
    """
    Info:
        [`MultiModalFieldConfig.flat`][vllm.io.inputs.multimodal.inputs.MultiModalFieldConfig.flat]
        [`MultiModalFieldConfig.flat_from_sizes`][vllm.io.inputs.multimodal.inputs.MultiModalFieldConfig.flat_from_sizes]
    """
...
class MultiModalSharedField(BaseMultiModalField):
    """
    Info:
        [`MultiModalFieldConfig.shared`][vllm.io.inputs.multimodal.inputs.MultiModalFieldConfig.shared]
    """
    batch_size: int
...
class MultiModalKwargs(UserDict[str, NestedTensors]):
    ...
    [`MultiModalDataItems`][vllm.io.inputs.multimodal.parse.MultiModalDataItems], via
    [`get_item`][vllm.io.inputs.multimodal.inputs.MultiModalKwargs.get_item] and
    [`get_items`][vllm.io.inputs.multimodal.inputs.MultiModalKwargs.get_items].
    """
...
class MultiModalEncDecInputs(MultiModalInputs):
    """
    Represents the outputs of
    [`EncDecMultiModalProcessor`][vllm.io.inputs.multimodal.processing.EncDecMultiModalProcessor]
    ready to be passed to vLLM internals.
    """
