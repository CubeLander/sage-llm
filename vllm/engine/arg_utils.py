...
class EngineArgs:
    ...
    kv_transfer_config: Optional[KVTransferConfig] = None  # HOTLLM_OPTIMIZATION: Can be removed if disaggregated prefilling not needed
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        vllm_group.add_argument("--kv-transfer-config",  # HOTLLM_OPTIMIZATION: This argument can be removed
    ...
    def create_engine_config(
        ...
        config = VllmConfig(
            ...
            kv_transfer_config=self.kv_transfer_config,  # HOTLLM_OPTIMIZATION: Can be removed or set to None
